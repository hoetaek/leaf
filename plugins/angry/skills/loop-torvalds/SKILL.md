---
name: loop-torvalds
description: "Bounded review/fix loop using torvalds as the engine — find the highest-priority issue, fix it, verify, repeat within budget. For a diff, PR, branch, or repo. Triggers: torvalds loop, loop-torvalds, maintainer review loop."
---
...
2. Run one `torvalds` review pass to produce serious candidates and pick
