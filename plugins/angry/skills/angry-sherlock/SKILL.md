---
name: angry-sherlock
description: Debugging review — does the diagnosis follow from evidence, or is it a guess? Hunts theories formed before data, ignored clues, symptom-only fixes. Not for claim-understanding (→ angry-feynman) or falsifiability (→ angry-pauli). Profane only on request.
---
