...
|---|---|---|---|---|---|---|
| Execution-first Loop | Existing request and repository state | One small reversible proof | Failing test, reproduction, measurement, or minimum prototype | The stated failure/current-state observation | First evidence, then concise ③–⑦ records | evidence established, blocked, approval-required, return to Learn |
