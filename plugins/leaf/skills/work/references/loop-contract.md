...
|---|---|---|---|---|---|---|
| Execution-first Loop | Existing request and repository state | One small reversible proof | Failing test, reproduction, measurement, or minimum prototype | The stated failure/current-state observation | Existing issue, PR, commit, or final handoff | verified implementation, blocked, approval-required, escalation to Learn |
