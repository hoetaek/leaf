...
Homebrew release automation is configured with cargo-dist. After the first
release is tagged and the Homebrew tap secret is configured, install with:
...
`hoetaek/homebrew-tap` when a SemVer tag points at a commit contained in `main`.
