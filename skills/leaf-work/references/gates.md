...
① belongs to `leaf-learn`. Its detailed contract lives in
`../../leaf-learn/references/gate-01-intent.md`; use that file as the pass/fail
...
intent is wrong, return to `leaf-learn` or revise the sprout's Learn files
against `../../leaf-learn/references/gate-01-intent.md` before continuing.

## ② Unknowns & Context

② belongs to `leaf-learn`. Its detailed contract lives in
`../../leaf-learn/references/gate-02-unknowns-context.md`; use that file as the
